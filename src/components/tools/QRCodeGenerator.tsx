...
export const QRCodeGenerator: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
          ...
          <div className="p-6 sm:p-8 glass rounded-[1.5rem] sm:rounded-[2.5rem] border border-white/5 relative overflow-hidden h-full flex flex-col justify-center">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-cyber-purple/10 rounded-xl sm:rounded-2xl flex items-center justify-center border border-cyber-purple/20 shadow-[0_0_20px_rgba(168,85,247,0.1)]">
                  <QrCode className="w-5 h-5 sm:w-6 sm:h-6 text-cyber-purple" />
                </div>
                <div>
                  ...
                  <p className="text-[10px] font-black text-cyber-purple/60 uppercase tracking-[0.3em]">Matrix Synthesis v4.0</p>
                </div>
              </div>
      ...
      {/* Grid Section */}
      {sessions.length === 0 ? (
        <div className="py-20 sm:py-40 flex flex-col items-center justify-center text-center glass border border-white/5 rounded-[1.5rem] sm:rounded-[3rem]">
          <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white/5 rounded-2xl sm:rounded-3xl flex items-center justify-center mb-6 border border-white/5">
          ...
          <button 
            onClick={openAddModal}
            className="mt-6 sm:mt-8 text-cyber-purple text-[10px] font-black uppercase tracking-widest hover:text-white transition-colors"
          >
          ...
          <AnimatePresence mode="popLayout">
            {sessions.map((session) => (
              <motion.div
                ...
                className="glass rounded-[1.5rem] sm:rounded-[2.5rem] border border-white/5 hover:border-cyber-purple/40 group relative flex flex-col overflow-hidden transition-all hover:shadow-[0_0_40px_rgba(168,85,247,0.1)]"
              >
                {/* Hover Glow */}
                ...
                <div className="p-5 sm:p-6 flex items-start justify-between border-b border-white/5 relative z-10">
                  ...
                  <div className="flex gap-1">
                    <button 
                      ...
                      className="p-2 bg-white/5 hover:bg-cyber-purple/20 text-slate-500 hover:text-cyber-purple rounded-lg sm:rounded-xl transition-all border border-white/5 hover:border-cyber-purple/30"
                    >
                      <Edit2 className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
                    </button>
                    <button 
                      onClick={() => deleteSession(session.id)}
                      className="p-2 bg-white/5 hover:bg-cyber-red/20 text-slate-500 hover:text-cyber-red rounded-lg sm:rounded-xl transition-all border border-white/5 hover:border-cyber-red/30"
                    >
                ...
                <div className="p-6 sm:p-8 flex flex-col items-center gap-6 sm:gap-8 relative z-10">
                  <div className="relative group/qr">
                    ...
                    <div className="relative bg-white p-4 sm:p-5 rounded-[1.5rem] sm:rounded-[2.5rem] shadow-2xl group-hover/qr:scale-105 transition-transform duration-500 border-4 border-cyber-purple/10 group-hover:border-cyber-purple/30">
                      <QRCodeSVG
                  ...
                  <div className="w-full space-y-4">
                    <div className="p-4 bg-dark-900/50 rounded-xl sm:rounded-2xl border border-white/5 group-hover:border-cyber-purple/30 transition-colors">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <button
                        ...
                        className="py-3 sm:py-3.5 bg-cyber-purple/10 hover:bg-cyber-purple/20 text-cyber-purple rounded-lg sm:rounded-xl font-black text-[9px] uppercase tracking-widest flex items-center justify-center gap-2 transition-all border border-cyber-purple/20 hover:border-cyber-purple/40"
                      >
                        <Download className="w-3 h-3 sm:w-3.5 sm:h-3.5" /> Export
                      </button>
                      <button
                        onClick={() => copyContent(session.id, session.content)}
                        className="py-3 sm:py-3.5 bg-white/5 hover:bg-white/10 text-slate-300 rounded-lg sm:rounded-xl font-black text-[9px] uppercase tracking-widest flex items-center justify-center gap-2 transition-all border border-white/5 group-hover:border-white/20"
                      >
                        {copiedId === session.id ? <Check className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-cyber-cyan" /> : <Copy className="w-3 h-3 sm:w-3.5 sm:h-3.5" />}
        ...
        {showAddModal && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div 
              ...
              className="relative w-full max-w-md bg-dark-900 rounded-[2rem] sm:rounded-[3rem] border border-white/5 p-6 sm:p-10 shadow-[0_0_50px_rgba(0,0,0,0.5)]"
            >
              <div className="flex items-center justify-between mb-6 sm:mb-10">
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-cyber-purple/20 rounded-xl sm:rounded-2xl flex items-center justify-center border border-cyber-purple/30 shadow-[0_0_15px_rgba(155,93,229,0.2)]">
                    {editingSession ? <Edit2 className="w-5 h-5 sm:w-6 sm:h-6 text-cyber-purple" /> : <Plus className="w-5 h-5 sm:w-6 sm:h-6 text-cyber-purple" />}
                  </div>
                  <div>
                    <h3 className="text-lg sm:text-xl font-black text-white tracking-tight uppercase hover-glitch cursor-default">
              ...
              <div className="space-y-6 sm:space-y-8">
                <div className="space-y-2 sm:space-y-3">
                  ...
                  <input
                    ...
                    className="w-full p-4 sm:p-5 bg-dark-800 border border-white/5 rounded-xl sm:rounded-2xl text-sm font-bold text-white placeholder:text-slate-700 focus:ring-2 focus:ring-cyber-purple/50 outline-none transition-all"
                  />
                </div>
                ...
                <div className="space-y-2 sm:space-y-3">
                  ...
                  <textarea
                    ...
                    className="w-full h-20 sm:h-32 p-4 sm:p-5 bg-dark-800 border border-white/5 rounded-xl sm:rounded-2xl text-sm font-mono text-cyber-purple placeholder:text-slate-700 focus:ring-2 focus:ring-cyber-purple/50 outline-none transition-all resize-none"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 sm:gap-6">
                  <div className="space-y-2 sm:space-y-3">
                    ...
                    <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-dark-800 border border-white/5 rounded-xl sm:rounded-2xl">
                      <input 
                        type="color" 
                        value={newColor} 
                        onChange={(e) => setNewColor(e.target.value)}
                        className="w-8 h-8 sm:w-10 sm:h-10 bg-transparent border-none cursor-pointer rounded-lg overflow-hidden"
                      />
                      <span className="text-[9px] sm:text-[10px] font-mono text-slate-500 uppercase">{newColor}</span>
                    </div>
                  </div>
                  <div className="space-y-2 sm:space-y-3">
                    ...
                    <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-dark-800 border border-white/5 rounded-xl sm:rounded-2xl">
                      <input 
                        ...
                        className="w-8 h-8 sm:w-10 sm:h-10 bg-transparent border-none cursor-pointer rounded-lg overflow-hidden"
                      />
                      <span className="text-[9px] sm:text-[10px] font-mono text-slate-500 uppercase">{newBgColor}</span>
                    </div>
                  </div>
                </div>
                ...
                <button
                  onClick={saveSession}
                  disabled={!newContent}
                  className="w-full py-4 sm:py-6 bg-cyber-purple hover:bg-cyber-purple/90 text-white rounded-xl sm:rounded-2xl font-black text-xs uppercase tracking-[0.4em] shadow-lg shadow-cyber-purple/20 transition-all active:scale-[0.98] disabled:opacity-50"
                >
